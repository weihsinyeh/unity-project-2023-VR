...
public class player_weapon_VR : MonoBehaviour
{
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        if(!SlashVR.GetState(SteamVR_Input_Sources.RightHand)) return;//!InputManager.GetButton("Slash")
   ...
   // }
    ...
    private void createObject(GameObject origin, Element element, Vector3 transNormal, bool set){
        ...
        if (set){
            ...
            if(origin.GetComponentInParent<PortalTraveller>()) obj.AddComponent<PortalTraveller>();
