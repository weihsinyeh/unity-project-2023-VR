...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_TimeChange p_TimeChange;
        
        private static SteamVR_Input_ActionSet_Movement p_Movement;
        ...
        public static SteamVR_Input_ActionSet_TimeChange TimeChange
        {
            get
            {
                return SteamVR_Actions.p_TimeChange.GetCopy<SteamVR_Input_ActionSet_TimeChange>();
            }
        }
        
        public static SteamVR_Input_ActionSet_Movement Movement
        {
            get
            {
                return SteamVR_Actions.p_Movement.GetCopy<SteamVR_Input_ActionSet_Movement>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_TimeChange = ((SteamVR_Input_ActionSet_TimeChange)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_TimeChange>("/actions/TimeChange")));
            SteamVR_Actions.p_Movement = ((SteamVR_Input_ActionSet_Movement)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Movement>("/actions/Movement")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.TimeChange,
                    SteamVR_Actions.Movement};
        }
    }
}
